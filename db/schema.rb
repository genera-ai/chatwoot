...
ActiveRecord::Schema[7.1].define(version: 2025_08_25_070005) do
  ...
  create_table "genera_atende_billing_plans", force: :cascade do |t|
    t.string "name", limit: 255, null: false
    ...
    t.integer "message_limit", default: 0, null: false
    t.integer "agent_limit", default: 0, null: false
    t.integer "storage_limit", default: 0, null: false
    t.decimal "message_overage_price", precision: 10, scale: 4, default: "0.01"
    t.decimal "agent_overage_price", precision: 10, scale: 2, default: "5.0"
    t.decimal "storage_overage_price", precision: 10, scale: 2, default: "0.1"
    t.json "features", default: []
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["featured"], name: "index_genera_atende_billing_plans_on_featured"
    t.index ["name"], name: "index_genera_atende_billing_plans_on_name", unique: true
    t.index ["status"], name: "index_genera_atende_billing_plans_on_status"
  end

  create_table "genera_atende_subscriptions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["billing_plan_id"], name: "index_genera_atende_subscriptions_on_billing_plan_id"
    t.index ["status"], name: "index_genera_atende_subscriptions_on_status"
    t.index ["stripe_customer_id"], name: "index_genera_atende_subscriptions_on_stripe_customer_id"
    t.index ["stripe_subscription_id"], name: "index_genera_atende_subscriptions_on_stripe_subscription_id", unique: true
    t.index ["tenant_id"], name: "index_genera_atende_subscriptions_on_tenant_id"
  end

  create_table "genera_atende_tenants", force: :cascade do |t|
    t.string "name", limit: 255, null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["domain"], name: "index_genera_atende_tenants_on_domain", unique: true
    t.index ["status"], name: "index_genera_atende_tenants_on_status"
    t.index ["subdomain"], name: "index_genera_atende_tenants_on_subdomain", unique: true
  end

  create_table "genera_atende_workspace_users", force: :cascade do |t|
    t.bigint "workspace_id", null: false
    t.bigint "user_id", null: false
    t.string "role", limit: 20, default: "agent", null: false
    t.datetime "joined_at", precision: nil, default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.datetime "last_active_at", precision: nil
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["last_active_at"], name: "index_genera_atende_workspace_users_on_last_active_at"
    t.index ["role"], name: "index_genera_atende_workspace_users_on_role"
    t.index ["user_id"], name: "index_genera_atende_workspace_users_on_user_id"
    t.index ["workspace_id", "user_id"], name: "index_genera_atende_workspace_users_on_workspace_id_and_user_id", unique: true
    t.index ["workspace_id"], name: "index_genera_atende_workspace_users_on_workspace_id"
  end

  create_table "genera_atende_workspaces", force: :cascade do |t|
    t.bigint "tenant_id", null: false
    t.string "name", limit: 255, null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["status"], name: "index_genera_atende_workspaces_on_status"
    t.index ["tenant_id", "slug"], name: "index_genera_atende_workspaces_on_tenant_id_and_slug", unique: true
    t.index ["tenant_id"], name: "index_genera_atende_workspaces_on_tenant_id"
  end
  ...
  add_foreign_key "genera_atende_subscriptions", "genera_atende_billing_plans", column: "billing_plan_id"
  add_foreign_key "genera_atende_subscriptions", "genera_atende_tenants", column: "tenant_id"
  add_foreign_key "genera_atende_workspace_users", "genera_atende_workspaces", column: "workspace_id"
  add_foreign_key "genera_atende_workspace_users", "users"
  add_foreign_key "genera_atende_workspaces", "genera_atende_tenants", column: "tenant_id"
