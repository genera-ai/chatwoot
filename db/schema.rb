...
ActiveRecord::Schema[7.1].define(version: 2025_09_16_024703) do
  ...
  create_table "account_billing_plans", force: :cascade do |t|
    ...
    t.index ["account_id"], name: "index_account_billing_plans_on_account_id", unique: true
    t.index ["active"], name: "index_account_billing_plans_on_active"
    t.index ["plan_name"], name: "index_account_billing_plans_on_plan_name"
    t.index ["stripe_customer_id"], name: "index_account_billing_plans_on_stripe_customer_id"
  end
  ...
  add_foreign_key "account_billing_plans", "accounts"
