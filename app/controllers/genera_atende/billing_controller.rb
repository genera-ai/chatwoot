...
module GeneraAtende
  class BillingController < GeneraAtende::ApplicationController
    ...
    def update_plan
      ...
      redirect_to genera_atende_billing_path, alert: 'Billing plan not found.'
    end
    ...
    def cancel_subscription
      ...
      if @current_subscription&.cancel!
        redirect_to genera_atende_billing_path, notice: 'Subscription cancelled successfully.'
      else
        redirect_to genera_atende_billing_path, alert: 'Unable to cancel subscription.'
      end
    end
    ...
    def add_payment_method
      ...
      redirect_to genera_atende_billing_path, notice: 'Payment method integration coming soon.'
    end

    def remove_payment_method
      # TODO: Implement payment method removal
      redirect_to genera_atende_billing_path, notice: 'Payment method removal coming soon.'
    end
    ...
    def ensure_admin_access
      ...
      redirect_to genera_atende_billing_path, alert: 'Only workspace admins can manage billing.'
    end
    ...
    def create_new_subscription(plan)
      ...
      if subscription.save
        redirect_to genera_atende_billing_path, notice: 'Subscription created successfully.'
      else
        redirect_to genera_atende_billing_path, alert: 'Unable to create subscription.'
      end
    end
    ...
    def upgrade_subscription(plan)
      ...
      if new_subscription.save
        ...
        redirect_to genera_atende_billing_path, notice: 'Plan upgraded successfully.'
      else
        redirect_to genera_atende_billing_path, alert: 'Unable to upgrade plan.'
      end
    end
    ...
    def fetch_invoices(_subscription)
